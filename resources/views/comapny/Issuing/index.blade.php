...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //         $.ajax({
            //             url: '../company/issuing/search-vehicle',
            //             type: 'GET',
            //             data: {
            ...
            //                     $('#car_made_date').val(response.data.car_made_date).trigger(
            //                         'change');
            //                     $('#cars_id').val(response.data.cars_id).trigger('change');
            //                     $('#vehicle_nationalities_id').val(response.data
            //                         .vehicle_nationalities_id).trigger('change');
            //                     $('#countries_id').val(response.data.countries_id).trigger(
            //                         'change');
            //                     $('#insurance_clauses_id').val(response.data
            //                         .insurance_clauses_id).trigger('change');
