    ...
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content ">
                <h4 class="box-title"><a href="{{ route('company/offices_users',$officesUser->offices_id) }}"> مستخدمين مكاتب  </a>/تعديل مستخدم مكتب </h4>
            </div>
        </div>
        <div class="col-md-12">
            <div class="box-content">
                ...
                <form method="POST" enctype="multipart/form-data" action="">
                    ...
                    @if($officesUser->user_type_id ==2)
                    <div class="form-group  col-md-3" id="userpermisson">
                     @else
