    ...
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content ">
                <h4 class="box-title"><a href="{{ route('company/offices_users',$officeid) }}"> المكاتب </a>/اضافة مستخدم مكتب </h4>
            </div>
        </div>
        <div class="col-md-12">
            <div class="box-content">
                ...
                <form method="POST" enctype="multipart/form-data" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group  col-md-3">
                            ...
                            <select  name="user_type_id" id="user_type_id" onchange="toggleUserPermissonDiv()" class="form-control @error('user_type_id') is-invalid @enderror  select2  wd-250"  data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" required>
                        ...
                        <div class="form-group col-md-3" id="userpermisson" style="display: none">
