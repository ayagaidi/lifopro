@extends('comapny.app')
@section('title', 'تقرير مخزون المكاتب ')
    ...
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content">
                ...
                <h4 class="box-title"><a href="{{ route('company/card') }}">التقارير</a>/ تقرير مخزون المكاتب </h4>
        ...
        <div class="row small-spacing">
            ...
            <div class="col-md-12">
                <div class="box-content ">
                    <h4 class="box-title">عرض مخزون المكاتب</h4>
                       <div class="mb-3">
                        <a href="{{ route('company/report/stock/stockpdf') }}" target="_blank" class="btn btn-primary btn-bordered waves-effect waves-light">PDF</a>
