...
@section('content')
<form method="POST" class="frm-single" id="otp-form" action="{{ route('company.2fa.verify') }}">
    @csrf

    <div class="inside">
        <a href="{{ route('company/login') }}" style="text-align: center;color: #a25541;" class="button-back">
            رجوع إلى تسجيل الدخول<span class="fa fa-arrow-left" style="color: #a25541;font-size: larger;"></span>
        </a>
