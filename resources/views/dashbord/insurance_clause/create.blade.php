@extends('layouts.app')
@section('title', 'اضافة بند التامين')

@section('content')
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content ">
                <h4 class="box-title"><a href="{{ route('insurance_clause') }}"> بند التامين</a>/اضافة بند التامين</h4>
            </div>
        </div>
        <div class="col-md-6">
            <div class="box-content">
                <form method="POST" class="" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror"
                            value="{{ old('slug') }}" id="slug" placeholder="الوصف">
                        @error('slug')
                            <span class="invalid-feedback" style="color: red" role="alert">
                                {{ $message }}
                            </span>
