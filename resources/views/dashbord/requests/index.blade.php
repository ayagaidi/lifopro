    ...
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content">
                ...
                <a type="button" href="{{ route('cardrequests/create') }}"
                    class="btn btn-primary btn-bordered waves-effect waves-light col-sm-3 ">اضافة طلب</a>
