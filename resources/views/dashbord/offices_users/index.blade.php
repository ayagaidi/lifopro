...
@section('content')
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content">
                ...
                <a type="button" href="{{ route('offices_users/create',$Office->id) }}"
                    class="btn btn-primary btn-bordered waves-effect waves-light "> اضافةمستخدمين مكتب {{$Office->name}} </a>
            </div>
        </div>
        <div class="row small-spacing">
            <div class="col-md-12">
                <div class="box-content ">
                    <h4 class="box-title">عرض مستخدمين مكتب   {{$Office->name}}  </h4>
 ...
 ajax: '{!! route('offices_users/offices_users', ['id' => $officeid]) !!}',
                                            columns: [
                                                {
                                                    data: 'username'
                                                },
                                                ...
                                                {
                                                    data: 'changepassordoffices_users'
                                                }
