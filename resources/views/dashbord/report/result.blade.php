    ...
    <script>
        $(document).ready(function() {
            ...
            function printForm() {
                ...
                const today = new Date().toLocaleString('ar-LY', {
...
@foreach($chunks as $chunkIndex => $chunk)
    <table id="datatable1" class="table table-bordered table-hover dataTable table-custom" style="cursor: pointer;">
        <thead>
            <tr>
                <th>#</th>
                <th>رقم البطاقة</th>
        ...
        <tbody>
            @foreach ($chunk as $index => $item)
                ...
                @endphp
                <tr>
                    <td>{{ $loop->iteration + ($chunkIndex * $perPage) }}</td>
