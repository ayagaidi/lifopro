@extends('layouts.app')
@section('title', ' مستخدمين الشركات  ')
...
@section('content')
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content">
                ...
                <a type="button" href="{{ route('company_users/create',$Company->id) }}"
                    class="btn btn-primary btn-bordered waves-effect waves-light col-sm-3 "> اضافةمستخدمين شركة {{$Company->name}} </a>
            </div>
        </div>
        <div class="row small-spacing">
            <div class="col-md-12">
                <div class="box-content ">
                    <h4 class="box-title">عرض مستخدمين شركة   {{$Company->name}}  </h4>
 ...
 ajax: '{!! route('company_users/company_users', ['id' => $comid]) !!}',
                                            columns: [
                                                {
                                                    data: 'username'
                                                },
