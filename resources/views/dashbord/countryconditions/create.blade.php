@extends('layouts.app')
@section('title', 'اضافة  شرط دولة')

@section('content')
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content ">
                <h4 class="box-title"><a href="{{ route('countryconditions') }}">شروط الدول</a>/اضافة شرط دولة</h4>
            </div>
        </div>
        <div class="col-md-12">
            <div class="box-content">
                <form method="POST" class="" action="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="unifiedofficaddress"
                            ...
                            placeholder="">{{ old('unifiedofficaddress') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="statementypecoverage"
                            class="form-control @error('statementypecoverage') is-invalid @enderror" id="statementypecoverage" placeholder="">{{ old('statementypecoverage') }}</textarea>
                    ...
                    <div class="form-group">
                        <button type="submit"
                            class="btn btn-primary waves-effect waves-light">{{ trans('city.addbtn') }}</button>
                    </div>
                </form>
            </div>
            <!-- /.box-content -->
