...
<div class="row small-spacing">
    <div class="col-md-12">
        <div class="box-content ">
            <h4 class="box-title"><a href="{{ route('activity') }}">السجلات</a>/عرض كافة السجلات</h4>
        </div>
    </div>
    <div class="col-md-12">
        <div class="box-content">
                    ...
                    <div class="{{ $containerHeaderClass }}" >
                        <div style="margin: 10px;display: flex; justify-content: space-between; align-items: center;" class="">
                            ...
                            {{-- <div class="btn-group pull-right btn-group-xs">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="right: auto;left: 0 !important;">
                                ...
                                @else
                                <ul class="dropdown-menu dropdown-menu-right" style="right: auto;left: 0 !important;">
