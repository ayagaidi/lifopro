    <div class="row mb-3">
      ...
      <div class="col-12 col-sm-4 col-lg-2 mb-2">
        ...
        <input type="text" class="frm-inp form-control " id='live_search_email' name='live_search_email' placeholder='Email'>
      </div>
      </div>
      
      <div class="col-12 col-sm-4 col-lg-2 mb-2">
        <div class="frm-input">
        <input type="text" id='live_search_userid' class="frm-inp form-control " name='live_search_userid' placeholder='UserId'>
      </div>
    </div>
