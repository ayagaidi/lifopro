    ...
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content">
                ...
                <h4 class="box-title"><a href="{{ route('office/home') }}">الرئيسية</a> </h4>
            ...
            <div class="col-lg-3 col-md-6 col-xs-12">
                <div class="box-content">
                    <div class="statistics-box with-icon">
                        ...
                        <h3 class="counter text-inverse" style="color: #aa5940 !important"> @if($cardsstockkk){{ $cardsstockkk->total_cards }} @else 0  @endif بطاقة</h2>
            ...
            <div class="col-lg-3 col-md-6 col-xs-12">
                <div class="box-content">
                    <div class="statistics-box with-icon">
                        ...
                        <p class="text" style="color: #773f2d">اجمالي معينة</p>
                    </div>
                </div>
                <!-- /.box-content -->
            </div> 
