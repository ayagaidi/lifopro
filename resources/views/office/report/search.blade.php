    ...
    <div class="row small-spacing">
        <div class="col-md-12">
            <div class="box-content">
                ...
                <h4 class="box-title"><a href="{{ route('office/report/issuing') }}">ادارة التقارير</a>/ تقاريرالمبيعات</h4>
            ...
            <div class="box-content">
                ...
                <form method="GET" enctype="multipart/form-data" target="_blank"
                    action="{{ route('office/report/issuing/pdf') }}">
                    @csrf
                    <div id="user-type-id" data-user-type-id="{{ Auth::user()->user_type_id }}"></div>
   ...
   totalInstallment += parseFloat(response.data[i].insurance_installment) || 0;
                        ...
                        totalVersion     += parseFloat(response.data[i].insurance_version) || 0;
                                        ...
                                        $('#rowsss').append(
                                            ...
                                            '<td>' + response['data'][i].insurance_day_from + '</td>' +
                                            '<td>' + response['data'][i].nsurance_day_to + '</td>' +
                                            '<td>' + response['data'][i].insurance_days_number + '</td>' +
                                            '<td>' + (response['data'][i].cars ? response['data'][i].cars.name : response['data'][i].cars_id) + '</td>' +
                                            '<td>' + response['data'][i].plate_number + '</td>' +

                                            '<td>' + response['data'][i].chassis_number + '</td>' +
                                            '<td>' + response['data'][i].motor_number + '</td>' +
                                            '<td>' +
                                            v + '</td>' +
