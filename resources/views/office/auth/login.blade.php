...
content: "\f053"; /* FontAwesome arrow-left icon */
}
...
<form method="POST" class="frm-single" action="">
    ...
    <div class="inside">
        ...
        <div class="title"><strong>  تسجيل دخول مكاتب</strong></div>
        <!-- /.title -->
        <!-- /.frm-title -->
        
        <div class="frm-input"><input type="text"  name="username" placeholder="اسم المستخدم" class="frm-inp form-control @error('username') is-invalid @enderror" value="{{ old('username') }}"><i class="fa fa-user frm-ico"></i></div>
        @error('username')
    ...
    <div class="form-group row ">
        <div class="col-md-8">
                ...
                <div class="captcha"  align="center" style="padding: 3px" >
                  ...
                  <button type="button" onclick="refreshcaptcha()" style="background: #ca6d37" class="btn btn-primary btn-block btn-signin"><i class="fa fa-refresh" id="refresh"></i></button>
    ...
    @endif
        ...
        <!-- /.clearfix -->
        <button type="submit" class="frm-submit" style="background-color: #ca6d37;">{{trans('login.login')}}<i class="fa fa-arrow-circle-right"></i></button>
